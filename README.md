...
1. Install [Node.js](https://nodejs.org) and clone the website repository
...
4. Open your browser and visit `http://localhost:8010` to get started. The following commands are also available:
...
5. Build the website with `npm run build` and deploy as a static website.
...
name: 'author-name'
pronouns: 'he/him'
avatar: 'https://gravatar.com/avatar/<link to avatar>'
bio: ''
